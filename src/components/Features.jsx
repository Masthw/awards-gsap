  ...
  return (
    <div className="relative size-full">
      ...
      <div
        ...
        style={{ color: "var(--color-blue-50)" }}
      >
        <div>
          <h1 className="bento-title special-font font-zentry">{title}</h1>
          {description && (
    ...
    <section className="bg-black pb-52">
      <div className="container mx-auto px-3 md:px-10">
        <div className="px-5 py-32">
          <p
            className="font-circular text-lg"
            style={{ color: "var(--color-blue-50)" }}
          >
            Into the Metagame Layer
          </p>
          <p
            className="max-w-md font-circular text-lg opacity-50"
            style={{ color: "var(--color-blue-50)" }}
          >
            Immerse yourself in a rich and ever-expanding unvierse where a
        ...
        <div className="grid h-[135vh] w-full grid-cols-2 grid-rows-3 gap-7">
          ...
          <BentoTilt className="bento-tilt_1 border-hsla row-span-1 ms-32 md:col-span-1 md:ms-0">
            <BentoCard
              ...
              description="A gamified social hub, adding a new dimension of play to social interacation for Web3 communities."
            />
          </BentoTilt>
          ...
          <BentoTilt className="bento-tilt_2">
            ...
            >
              <h1 className="bento-title special-font font-zentry max-w-64 text-black">
